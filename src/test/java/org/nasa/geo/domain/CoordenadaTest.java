...
import org.nasa.geo.domain.exceptions.CoordenadaForaDaTerraException;
...
class CoordenadaTest {
    ...
    void recusaLatitudeForaDoIntervalo() {
        var erro = assertThrows(CoordenadaForaDaTerraException.class, () -> new Coordenada(90.1, 0));
        assertTrue(erro.getMessage().contains("latitude"), erro.getMessage());
        assertThrows(CoordenadaForaDaTerraException.class, () -> new Coordenada(-90.1, 0));
    }

    @Test
    @DisplayName("recusa longitude fora de [-180, 180]")
    void recusaLongitudeForaDoIntervalo() {
        var erro = assertThrows(CoordenadaForaDaTerraException.class, () -> new Coordenada(0, 180.1));
        assertTrue(erro.getMessage().contains("longitude"), erro.getMessage());
        assertThrows(CoordenadaForaDaTerraException.class, () -> new Coordenada(0, -180.1));
    }

    @Test
    @DisplayName("recusa NaN")
    void recusaNaN() {
        assertThrows(CoordenadaForaDaTerraException.class, () -> new Coordenada(Double.NaN, 0));
        assertThrows(CoordenadaForaDaTerraException.class, () -> new Coordenada(0, Double.NaN));
    }
    ...
    void talvezDistingueAusenteDeErrado() {
        assertThrows(CoordenadaForaDaTerraException.class, () -> Coordenada.talvez(999.0, 0.0));
    }
